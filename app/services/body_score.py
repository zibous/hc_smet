...
class bodyScore:
    def __init__(
        self, age, sex, height, weight, bmi, bodyfat, muscle, water, visceral_fat, bone, basal_metabolism, protein
    ):
        self.age = age
        self.sex = sex
        self.height = height
    ...
    def getBmiDeductScore(self):
        ...
        # Normal or high bmi but too much bodyfat
            ...
            (self.bmi >= bmi_low and self.age < 18) or (self.bmi >= bmi_normal and self.age >= 18)
    ...
    def getBodyFatDeductScore(self) -> float:
    ...
    def getProteinDeductScore(self) -> float:
