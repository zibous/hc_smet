...
from fastapi.staticfiles import StaticFiles  # <-- NEU: Für ESM JavaScript & CSS Module
from fastapi.middleware.cors import CORSMiddleware  # <-- NEU: Für Proxy-Sicherheit
...
# Pfad zum Frontend-Verzeichnis definieren
...
# NEU: CORS Middleware hinzufügen (wichtig bei NGINX-Subpfaden oder Dev-Servern)
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
# API Routes (Müssen zwingend VOR den statischen Webseiten-Routen registriert werden!)
...
async def index(request: Request):
    """Dashboard HTML via Jinja2 ausliefern."""
...
# NEU: Statische Dateien (app.js, style.css, etc.) für den Browser verfügbar machen.
# html=False verhindert Konflikte mit der oben definierten Index-Route "/"
